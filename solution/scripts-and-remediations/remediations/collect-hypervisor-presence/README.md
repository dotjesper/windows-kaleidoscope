...
# Microsoft Intune remediation: Collect the availability of virtualization
...
Name: **Collect the presence of virtualization**

Description: **Collect the presence of virtualization, success if either processor supports and enabled or if Hyper-V is present.**
