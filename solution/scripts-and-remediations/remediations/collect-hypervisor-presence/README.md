...
# Microsoft Intune remediation: Detect virtualization support

Detect the availability of virtualization, and succeed if either the processor supports virtualization and has virtualization enabled, or if a hypervisor is present.
...
Name: **Detect virtualization support**

Description: **Detect virtualization support, succeed if either the processor supports virtualization and has virtualization enabled, or if a hypervisor is present.**
...
| Exit code | Output |
|:---------:|:-------|
| `exit 0` | `[00.000] Virtualization firmware check passed [VMMonitorModeExtensions: True \| VirtualizationFirmwareEnabled: True \| HypervisorPresent: True].` |
| `exit 1` | `[00.000] Virtualization firmware check failed [VMMonitorModeExtensions: True \| VirtualizationFirmwareEnabled: True \| HypervisorPresent: False].` |
