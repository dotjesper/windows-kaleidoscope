...
To address this concern, leveraging remediation script to collect the age of Windows Event Logs allow administrators to fine tune eventlog size.

The "Collect Windows Eventlog health" remediation script is engineered to easily collect the required information. By implementing this script, administrators can:
...
| Exit code | Output |
|:---------:|:-------|
| `exit 0` | `[00.000] All logs are healthy` |
| `exit 1` | `[00.000] Healthy logs: 5 \| Unhealthy logs: 2` |
