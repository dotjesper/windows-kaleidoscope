...
# Microsoft Intune remediation: Collect Windows last boot time

Collect Windows last boot time, fails if last boot time is 7 days or above.
...
Name: **Collect Windows last boot time**

Description: **Collect Windows last boot time, fails if last boot time is 7 days or above.**
...
| Exit code | Output |
|:---------:|:-------|
| `exit 0` | `[00.000] Device uptime is within the defined 14 days uptime threshold - last boot 3 days ago.` |
| `exit 1` | `[00.000] Device uptime has exceeded the defined 14 days uptime threshold - last boot 21 days ago - a restart is recommended.` |
