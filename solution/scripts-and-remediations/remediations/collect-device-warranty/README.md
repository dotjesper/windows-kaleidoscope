...
> Note: Warranty data is scraped from the vendor's web page using regex pattern matching. Changes to the vendor's page structure may require script updates.
...
Description: **Collect device warranty information from the vendor's website.**
...
| Exit code | Output |
|:---------:|:-------|
| `exit 0` | `[00.000] The warranty for the device with serial number [ABC123] is active [Start: 2023-01-15 \| End: 2026-01-15 \| 365 days remaining].` |
| `exit 0` | `[00.000] Undefined vendor [CustomVendor \| ABC123].` |
| `exit 1` | `[00.000] The warranty for the device with serial number [ABC123] is about to expire [Start: 2023-01-15 \| End: 2025-06-15 \| 30 days remaining].` |
| `exit 1` | `[00.000] The warranty for the device with serial number [ABC123] has expired [Start: 2023-01-15 \| End: 2025-01-15 \| Expired].` |
| `exit 1` | `[00.000] Cannot determine warranty end date for device with serial number [ABC123].` |
| `exit 1` | `[00.000] Failed to retrieve warranty information. Status Code: 401` |
