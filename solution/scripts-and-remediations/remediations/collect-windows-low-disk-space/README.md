...
# Microsoft Intune remediation: Collect low disk space inventory

Collect Windows disk usage, fails if system disk space usage is above defined disk space usage threshold.

## Script package information

Disk Space Usage Threshold in percentages (0-100): **80%**
...
Name: **Collect Windows disk usage**

Description: **Collect Windows disk usage, fails if system disk space usage is above 80%.**
...
| Exit code | Output |
|:---------:|:-------|
| `exit 0` | `[00.000] Disk usage on C: drive is below the threshold (65% used \| size: 512 GB)` |
| `exit 1` | `[00.000] Disk usage on C: drive is above the threshold (92% used \| size: 512 GB)` |
